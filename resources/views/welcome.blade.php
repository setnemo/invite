                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row mb-0 m-3"
                                ...
                                <div>
                                    ...
                                    @else
                                        <p class="lead">Для логіну ви використовуєте свій логін BlueSky. В більшості
                                            ...
                                            Їх можна і варто створювати аби логінитися своїм Bluesky аккаунтом на інших
                                            сайтах/застосунках.
                                            Це більш безпечно, адже так ви не надаєте свій основний пароль нікому крім
                                            офіційного застосунку Bluesky.</p>
                                    @endif
                                </div>
                            </div>
                        </form>
