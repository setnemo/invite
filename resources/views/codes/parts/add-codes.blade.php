    ...
    <div class="accordion-item">
        ...
        <div id="helpAddCodes" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
                ...
                <p class="lead">
                    Коли ви натискаєте кнопку "Записати інвайт-код 🎟️" автоматично робиться запит в BlueSky
                    по хендлу щоб забрати унікальний айді користувача, який дарує цей код і який ви вручну
                    забиваете в систему. Кожний користувач має такий, і всі посилання на юзерів BlueSky я роблю
                    ...
                    провідника. Після цього код падає в чергу
                </p>
            </div>
        </div>
    </div>
