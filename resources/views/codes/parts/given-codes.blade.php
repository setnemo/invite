    ...
    <div class="accordion-item">
        ...
        <div id="helpGivenCodes" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
                ...
                <ul>
                    <li>жовтим кількість кодів, які провідники взяли в роботу</li>
                    <li>зеленим кількість кодів, які провідники можуть взяти в роботу</li>
                </ul>
                <p class="lead">
                    Коди при наявності сортуються від старих до нових. В блоці коду ми можемо побачити:
                </p>
                <ul>
                    <li>хто дарує з посиланням на BlueSky</li>
